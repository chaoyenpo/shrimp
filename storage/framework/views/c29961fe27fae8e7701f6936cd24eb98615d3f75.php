...
<div id="app">
    <b-form method="POST" action="<?php echo e(url('full-tw-game')); ?>/<?php echo e($record['id']); ?>" @submit="onSubmit" @reset="onReset">
      <?php echo csrf_field(); ?>
...
$("#delete").click(function(){
    $.ajax({
        url: "<?php echo e(url('full-tw-game')); ?>/<?php echo e($record['id']); ?>",
        ...
        success: function(data){
            alert('比賽刪除完成');
            location.href = "<?php echo e(url('full-tw-game')); ?>";
        },
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/full_tw_games/edit.blade.php ENDPATH**/ ?>