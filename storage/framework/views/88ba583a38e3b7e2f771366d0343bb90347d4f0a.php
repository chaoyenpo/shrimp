...
<div class="row">
    <div class="col-md-12 my-3">
        ...
        <a href="<?php echo e(url('full-tw-game')); ?>/create" class="btn btn-primary float-right" role="button" aria-pressed="true">新增比賽</a>
    </div>
</div>
      ...
      <tbody v-if="records.length">
        <tr v-for="(record,index) in records" v-bind:data-id="record.id">
          ...
          <td class="text-center" width="10%">
            <a :href="`<?php echo e(url('full-tw-game')); ?>/${record.id}/edit`" v-if="record.status != 'cancel'" class="btn btn-primary" role="button" aria-pressed="true">修改</a>
          </td>
        </tr>
      </tbody>
      <tbody v-else>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/full_tw_games/index.blade.php ENDPATH**/ ?>