...
<div id="app">
    <b-form method="POST" action="<?php echo e(url('shrimpFarmEvent')); ?>" @submit="onSubmit" @reset="onReset" v-if="show">
      <?php echo csrf_field(); ?>
      <div class="row mb-3">
...
var app = new Vue({
  ...
  data: {
    initial: {
      selected: <?php echo json_encode($selected, 15, 512) ?>,
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/shrimp_farms_events/create.blade.php ENDPATH**/ ?>