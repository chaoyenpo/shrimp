...
<div id="app">
    <b-form method="POST" action="<?php echo e(url('shrimpFarm')); ?>/<?php echo e($record['id']); ?>" @submit="onSubmit" @reset="onReset" v-if="show">
      <?php echo csrf_field(); ?>
...
var app = new Vue({
  el: '#app',
  data: {
    initial: <?php echo json_encode($record, 15, 512) ?>,
    form: <?php echo json_encode($record, 15, 512) ?>,
    days: ['日', '一', '二', '三', '四', '五', '六'],
    show: true
  },
  methods: {
...
$("#resetEvaluation").click(function(){
    $.ajax({
        url: "<?php echo e(url('shrimpFarm/Evaluation/reset')); ?>",
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shrimp\resources\views/shrimp_farms/edit.blade.php ENDPATH**/ ?>