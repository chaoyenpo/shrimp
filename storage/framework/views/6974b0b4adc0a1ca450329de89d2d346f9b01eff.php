      ...
      <tbody v-if="records.length">
        <tr v-for="(record,index) in records" v-bind:data-id="record.id">
          ...
          <td class="text-center" width="10%">
            ...
            <a :href="`<?php echo e(url('game')); ?>/${record.id}/pushPending`" v-if="record.status != 'cancel'" class="btn btn-primary" role="button" aria-pressed="true">催繳</a>
          </td>
        </tr>
      </tbody>
      <tbody v-else>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/games/index.blade.php ENDPATH**/ ?>