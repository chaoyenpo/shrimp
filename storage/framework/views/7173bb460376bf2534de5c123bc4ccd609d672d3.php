...
<div class="row">
    <div class="col-md-12 my-3">
        <span class="lead">新增釣具店</span>
        <a href="#" onclick="history.back()" class="btn btn-primary float-right" role="button" aria-pressed="true">返回</a>
    </div>
</div>

<div id="app">
    <b-form method="POST" action="<?php echo e(url('fishingTackleShop')); ?>" @submit="onSubmit" @reset="onReset" v-if="show">
      <?php echo csrf_field(); ?>
      <div class="row mb-3">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shrimp\resources\views/fishing_tackle_shops/create.blade.php ENDPATH**/ ?>