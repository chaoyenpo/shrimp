...
<div id="app">
    <b-form method="POST" action="<?php echo e(url('fishingTackleShop')); ?>/<?php echo e($record['id']); ?>" @submit="onSubmit" @reset="onReset" v-if="show">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shrimp\resources\views/fishing_tackle_shops/edit.blade.php ENDPATH**/ ?>