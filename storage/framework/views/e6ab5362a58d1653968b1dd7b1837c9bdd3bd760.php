...
<div id="app">
    <b-form method="POST" action="<?php echo e(url('shrimpFarmEvent')); ?>/<?php echo e($record['id']); ?>" @submit="onSubmit" @reset="onReset" v-if="show">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/shrimp_farms_events/edit.blade.php ENDPATH**/ ?>