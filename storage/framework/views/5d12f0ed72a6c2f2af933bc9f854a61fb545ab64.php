...
<div class="row">
    <div class="col-md-12 my-3">
        <span class="lead">修改廣告</span>
        <a href="#" onclick="history.back()" class="btn btn-primary float-right" role="button" aria-pressed="true">返回</a>
    </div>
</div>

<div id="app">
    <b-form method="POST" action="<?php echo e(url('ad')); ?>/<?php echo e($record['id']); ?>" @submit="onSubmit" @reset="onReset">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/ads/edit.blade.php ENDPATH**/ ?>