...
<div class="row mb-3">
    ...
    <div class="col-md-9">
        ...
        <div class="row">
            ...
            <div class="col-md-6">報名人數：<?php echo e($game->members(['ok','waiting','pending'])->count()); ?></div>
        </div>
        <div class="row">
...
<?php elseif($game->members(['ok','waiting'], $user->id)->first() || (!empty($member) && $member->is_pay)): ?>
...
<?php elseif($game->members(['pending','host_quota'], $user->id)->first()): ?>
    ...
    <?php endif; ?>
    <div class="row mb-3">
        <div class="col-md-12">確定要繳費嗎？將扣除 <?php echo e(env('SIGNUP_PRICE')); ?> 點報名費</div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12 text-center">
            <form method="POST">
...
<?php echo $__env->make('activities.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /volume/project/Shrimp/resources/views/games/mobile/signup.blade.php ENDPATH**/ ?>