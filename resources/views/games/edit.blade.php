...
<div class="row">
    <div class="col-md-12 my-3">
        ...
        <span class="float-right">
          <a href="{{ url('game') }}/{{ $record['id'] }}/personnel" class="btn btn-primary" role="button" aria-pressed="true">任命工作人員</a>
...
<div id="app">
    <b-form method="POST" action="{{ url('game') }}/{{ $record['id'] }}" @submit="onSubmit" @reset="onReset">
      @csrf
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
            @empty($host_main_personnel)
              尚未任命
            @else
              {{ $host_main_personnel->user->username }} {{ $host_main_personnel->user->phone }}
            @endempty
        </div>
      </div>
      <div class="row mb-3">
        ...
        <div class="col-md-6">
            @empty($host_personnel)
              尚未任命
            @else
              @foreach($host_personnel as $people)
