    ...
    <script>
        $(document).ready(function(){
            $("#back").click(function( event ) {
                location.href = "{{ url('api/ecpay/payBack') }}";
            });
        });
    </script>
</head>
...
<body style="font-size: 18pt;">
    <div>
        <img style="width: 30%; margin: 20px;" src="{{ asset('pay.png') }}">
        <div style="display: inline-block; height: 100%; position: relative; color: #0F2E4E;">
            <h1>儲值</h1>
        </div>
    </div>

    <form method="POST" action="{{ url('api/ecpay') }}">
        ...
        <div style="padding: 0px 20px;">
            ...
            <div class="row">
                <div class="col-md-2 pl-5">
                   <input type="radio" class="form-check-input" name="point" value="2500_1280_CVS" id="btn4"/>
                   <label for="btn2" class="form-check-label">2500蝦幣/NT1280</label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 pl-5">
            ...
            <div class="row">
                <div class="col-md-2 pl-5">
                   <input type="radio" class="form-check-input" name="point" value="2500_1265_ATM" id="btn4"/>
                   <label for="btn2" class="form-check-label">2500蝦幣/NT1265</label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 pl-5">
