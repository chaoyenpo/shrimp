...
<div class="row">
    <div class="col-md-12 my-3">
        ...
        <a href="{{ url('fishingTackleShop') }}/create" class="btn btn-primary float-right" role="button" aria-pressed="true">新增釣具店</a>
    </div>
</div>
      ...
      <tbody v-if="records.length">
        <tr v-for="(record,index) in records" v-bind:data-id="record.id">
          ...
          <td class="text-center" width="10%">
            <a :href="`{{ url('fishingTackleShop') }}/${record.id}/edit`" class="btn btn-primary" role="button" aria-pressed="true">修改</a>
          </td>
        </tr>
      </tbody>
      <tbody v-else>
