            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" id="nav-shrimpFarmEvent" href="{{ url('shrimpFarmEvent') }}">釣蝦場活動 <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-shrimpFarm" href="{{ url('shrimpFarm') }}">釣蝦場管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-fishingTackleShop" href="{{ url('fishingTackleShop') }}">釣具店管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-ad" href="{{ url('ad') }}">廣告管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-illustration" href="{{ url('illustration') }}">圖鑑管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-game" href="{{ url('game') }}">比賽管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-full-tw-game" href="{{ url('full-tw-game') }}">全台比賽管理</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nav-point" href="{{ url('point/add') }}">儲值管理</a>
                        </li>
                    </ul>
                </div>
            </nav>
